...
export default function AddCustomerPage() {
  ...
  const addDog = () => {
    ...
    setShowBreeds((prev) => ({ ...prev, [dogs.length]: false }));
  };
    ...
    try {
      ...
      const customerData = {
        ...
        dogs: validDogs.map((dog) => {
          let breedIdToUse = null;
          let customBreedToUse = null;

          if (dog.breedId && dog.breedId !== 'custom') {
            breedIdToUse = dog.breedId;
            customBreedToUse = null;
          } else {
            breedIdToUse = null;
            customBreedToUse = dog.customBreed;
          }

          return {
            name: dog.name,
            breedId: breedIdToUse,
            customBreed: customBreedToUse,
      ...
      router.push('/customer?success=created');
    } catch (error) {
