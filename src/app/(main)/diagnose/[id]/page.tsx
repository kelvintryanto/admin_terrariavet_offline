      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-4 mb-4">
        ...
        <div className="flex gap-2 w-full sm:w-auto">
          {canEditDiagnose(userRole) && (
            <Button
              variant="outline"
              onClick={() => router.push(`/diagnose/${id}/edit`)}
        ...
        <Card className="mt-4">
          ...
          <CardContent>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              <div className="flex items-center">
                <span className="font-medium mr-2">Berat Badan:</span>
                <span>
                  {diagnose.weight !== undefined && diagnose.weight !== null
                    ? `${diagnose.weight.toFixed(1)} kg`
                    : 'Tidak ada data'}
                </span>
              </div>
              <div className="flex items-center">
                <span className="font-medium mr-2">Tekanan Darah:</span>
                <span>
                  {diagnose.bloodPressure
                    ? diagnose.bloodPressure
                    : 'Tidak ada data'}
                </span>
              </div>
